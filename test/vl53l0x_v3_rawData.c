...
void vl53l0xTask(void* arg)
{
  ...
  while (1) {
    ...
    i2cdevRead(I2Cx, GRIDEYE_DEFAULT_ADDRESS, GRIDEYE_ADDR_BG_TEMP, 2, bg);
    i2cdevRead(I2Cx, GRIDEYE_DEFAULT_ADDRESS, PIXEL0 | GRIDEYE_ADDR_AUTO_INC, 128, data);
    for(int i=0;i<64;i++){
        rawData[i] = ((data[i*2+1] << 8) | data[i*2]);
        pixelTemp[i]= rawData[i] * 0.25f;
    }
    roomTemp = ((bg[1] << 8) | bg[0]) * 0.0625f;
...
void labelPixel(float* pixelTemp, uint8_t* color)
{
    for(int i=0; i<64; i++){
        ...
        if ((pixelTemp[i]-28.0f) < 1.0f){
            color[i]=WHITE;
        // }else if ((pixelTemp[i]-roomTemp) < THRESHOLD_LEVEL2){
        }else if ((pixelTemp[i]-28.0f) < 2.0f){
...
LOG_ADD(LOG_UINT16, rawDataC0, &rawData[0])
LOG_ADD(LOG_UINT16, rawDataC1, &rawData[1])
LOG_ADD(LOG_UINT16, rawDataC2, &rawData[2])
LOG_ADD(LOG_UINT16, rawDataC3, &rawData[3])
LOG_ADD(LOG_UINT16, rawDataC4, &rawData[4])
LOG_ADD(LOG_UINT16, rawDataC5, &rawData[5])
LOG_ADD(LOG_UINT16, rawDataC6, &rawData[6])
LOG_ADD(LOG_UINT16, rawDataC7, &rawData[7])
LOG_GROUP_STOP(gridEyeR0)

LOG_GROUP_START(gridEyeR1)
LOG_ADD(LOG_UINT16, rawDataC0, &rawData[8])
LOG_ADD(LOG_UINT16, rawDataC1, &rawData[9])
LOG_ADD(LOG_UINT16, rawDataC2, &rawData[10])
LOG_ADD(LOG_UINT16, rawDataC3, &rawData[11])
LOG_ADD(LOG_UINT16, rawDataC4, &rawData[12])
LOG_ADD(LOG_UINT16, rawDataC5, &rawData[13])
LOG_ADD(LOG_UINT16, rawDataC6, &rawData[14])
LOG_ADD(LOG_UINT16, rawDataC7, &rawData[15])
LOG_GROUP_STOP(gridEyeR1)

LOG_GROUP_START(gridEyeR2)
LOG_ADD(LOG_UINT16, rawDataC0, &rawData[16])
LOG_ADD(LOG_UINT16, rawDataC1, &rawData[17])
LOG_ADD(LOG_UINT16, rawDataC2, &rawData[18])
LOG_ADD(LOG_UINT16, rawDataC3, &rawData[19])
LOG_ADD(LOG_UINT16, rawDataC4, &rawData[20])
LOG_ADD(LOG_UINT16, rawDataC5, &rawData[21])
LOG_ADD(LOG_UINT16, rawDataC6, &rawData[22])
LOG_ADD(LOG_UINT16, rawDataC7, &rawData[23])
LOG_GROUP_STOP(gridEyeR2)

LOG_GROUP_START(gridEyeR3)
LOG_ADD(LOG_UINT16, rawDataC0, &rawData[24])
LOG_ADD(LOG_UINT16, rawDataC1, &rawData[25])
LOG_ADD(LOG_UINT16, rawDataC2, &rawData[26])
LOG_ADD(LOG_UINT16, rawDataC3, &rawData[27])
LOG_ADD(LOG_UINT16, rawDataC4, &rawData[28])
LOG_ADD(LOG_UINT16, rawDataC5, &rawData[29])
LOG_ADD(LOG_UINT16, rawDataC6, &rawData[30])
LOG_ADD(LOG_UINT16, rawDataC7, &rawData[31])
LOG_GROUP_STOP(gridEyeR3)

LOG_GROUP_START(gridEyeR4)
LOG_ADD(LOG_UINT16, rawDataC0, &rawData[32])
LOG_ADD(LOG_UINT16, rawDataC1, &rawData[33])
LOG_ADD(LOG_UINT16, rawDataC2, &rawData[34])
LOG_ADD(LOG_UINT16, rawDataC3, &rawData[35])
LOG_ADD(LOG_UINT16, rawDataC4, &rawData[36])
LOG_ADD(LOG_UINT16, rawDataC5, &rawData[37])
LOG_ADD(LOG_UINT16, rawDataC6, &rawData[38])
LOG_ADD(LOG_UINT16, rawDataC7, &rawData[39])
LOG_GROUP_STOP(gridEyeR4)

LOG_GROUP_START(gridEyeR5)
LOG_ADD(LOG_UINT16, rawDataC0, &rawData[40])
LOG_ADD(LOG_UINT16, rawDataC1, &rawData[41])
LOG_ADD(LOG_UINT16, rawDataC2, &rawData[42])
LOG_ADD(LOG_UINT16, rawDataC3, &rawData[43])
LOG_ADD(LOG_UINT16, rawDataC4, &rawData[44])
LOG_ADD(LOG_UINT16, rawDataC5, &rawData[45])
LOG_ADD(LOG_UINT16, rawDataC6, &rawData[46])
LOG_ADD(LOG_UINT16, rawDataC7, &rawData[47])
LOG_GROUP_STOP(gridEyeR5)

LOG_GROUP_START(gridEyeR6)
LOG_ADD(LOG_UINT16, rawDataC0, &rawData[48])
LOG_ADD(LOG_UINT16, rawDataC1, &rawData[49])
LOG_ADD(LOG_UINT16, rawDataC2, &rawData[50])
LOG_ADD(LOG_UINT16, rawDataC3, &rawData[51])
LOG_ADD(LOG_UINT16, rawDataC4, &rawData[52])
LOG_ADD(LOG_UINT16, rawDataC5, &rawData[53])
LOG_ADD(LOG_UINT16, rawDataC6, &rawData[54])
LOG_ADD(LOG_UINT16, rawDataC7, &rawData[55])
LOG_GROUP_STOP(gridEyeR6)

LOG_GROUP_START(gridEyeR7)
LOG_ADD(LOG_UINT16, rawDataC0, &rawData[56])
LOG_ADD(LOG_UINT16, rawDataC1, &rawData[57])
LOG_ADD(LOG_UINT16, rawDataC2, &rawData[58])
LOG_ADD(LOG_UINT16, rawDataC3, &rawData[59])
LOG_ADD(LOG_UINT16, rawDataC4, &rawData[60])
LOG_ADD(LOG_UINT16, rawDataC5, &rawData[61])
LOG_ADD(LOG_UINT16, rawDataC6, &rawData[62])
LOG_ADD(LOG_UINT16, rawDataC7, &rawData[63])
